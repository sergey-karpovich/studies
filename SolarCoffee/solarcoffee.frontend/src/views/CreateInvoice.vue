    ...
    <div>
        ...
        <div class="invoice-step" v-if="invoiceStep === 2">
            ...
            <div class="invoice-item-actions">
                <solar-button :disabled="!newItem.product || !newItem.quantity" @button:click="addLineItem">
                    Add Line Item
                </solar-button>

                <solar-button :disabled="!lineItems.length" @button:click="finalizeOrder">
                    Finalize Order
                </solar-button>
            </div>
            <div class="invoice-order-list" v-if="lineItems.length">
                <div class="runningTotal">
                    {{ runningTotal??0 | price }}
                </div>
                <hr />
                <table class="table">
                    <thead>
        ...
        <div class="invoice-step" v-if="invoiceStep === 3">
            ...
            <div class="invoice-step-detail" id="invoice" ref="invoice">
                <div class="invoice-logo">
                    <img id="imgLogo" alt="Solar Coffee logo" src="../assets/images/Bee animation 3.png" />
                    <h3>1337 Solar Lane</h3>
                    <h3>San Somewhere, CA 9000</h3>
                    <h3>USA</h3>
                        ...
                        <table class="table">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="price-final">{{ runningTotal??0 | price }}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
        ...
        <div class="invoice-steps-actions">
            ...
            <solar-button @button:click="startOver">
                Start Over
            </solar-button>
        </div>
...
export default
    {
        ...
        methods:
        {
            ...
            async submitInvoice() 
            {
                ...
                await this.$store.dispatch('makeNewInvoice', this.invoice)
                //this.startOver();
