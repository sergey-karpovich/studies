...
console.log(parseFloat(' 2.5remlkjsdlkgfjsdlk'));
...
console.log(Number.isFinite(234/0));
...
console.log(Math.max(2,18,'23',11,2));
console.log(Math.max(2,18,'23px',11,2));

console.log(Math.min(2,18,'23',11,2));
...
// console.log(Number('230_000')); don't work
// console.log(parseInt('23_000_000'));
...
console.log(58585858854859835245234234234234234234234n);
console.log(BigInt(342987263498723648972364238746234642));
// Operations
console.log(10000n+10000n);
console.log(1000123421342134231423140n*10234234234234000n);

const huge=23423423542352352n;
const num=23;
...
console.log(new Date(3*25*60*60*1000));
...
//     seconds:'numeric'
//   };
//   labelTimer.innerHTML=new Intl.DateTimeFormat(navigator.locale).format(now);
