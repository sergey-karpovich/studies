        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RechnungPositionId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Developers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Developers_RechnungPosition_RechnungPositionId",
                        column: x => x.RechnungPositionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Developers_RechnungPositionId",
                table: "Developers",
                column: "RechnungPositionId");
